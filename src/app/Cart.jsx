          ...
          <div className="col-md-8 cart">
            <div className="title">
              <div className="row">
                ...
                <div className="col align-self-center text-right text-muted">{ProductCount} товары</div>
            ...
            <div className="row border-top border-bottom">
              <div className="row main align-items-center">
                ...
                <div className="col">{product.price * product.quantity}00 сом  <span className="close" onClick={() => DeleteProduct(product.id)}>&#10005;</span></div>
              </div>
            </div>
            ))}
            <div className="back-to-shop"><Link to="/"><FaLongArrowAltLeft/></Link><span className="text-muted">Вернуться</span></div>
          </div>
          <div className="col-md-4 summary">
            <div><h5><b>Краткое содержание</b></h5></div>
            <hr />
            <div className="row">
              <div className="col" style={{ paddingLeft: 13 }}>{ProductCount} Количество продукта:</div>
              <div className="col text-right"> {totalPrice}00 сом</div>
            </div>
         
            <form>
              <p>ДОСТАВКА</p>
              <select><option className="text-muted">Стандартная доставка - 450 сом</option></select>
              <p>ПОДАРОЧНЫЙ КОД</p>
              <input id="code" placeholder="Enter your code" />
            </form>
            <div className="row" style={{ borderTop: "1px solid rgba(0,0,0,.1)", padding: "2vh 0" }}>
              <div className="col">Общая стоимость:</div>
              <div className="col text-right"> {totalPrice} сом</div>
            </div>
