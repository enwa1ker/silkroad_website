  ...
  return (
    ...
    <FormControl className="FilterBar">
         ...
         <Box sx={{ width: 300 }} className="Filterprice">
            <Typography className='priceText'>Цена</Typography>
            ...
            <Button variant="contained" onClick={handlePriceFilter} className='Price-Filter-Button'>Фильтр</Button>
          </Box>
     </FormControl>
                ...
                <div className="row">
                  <div className="el-wrapper">
                    ...
                    <div className="box-down">
                      ...
                      <Link className="cart">
                        <span className="price">{product.price}00 сом</span>
                        <span className="add-to-cart">
                          <span className="txt" >
                            <Link className='GoToCartLink' onClick={() => toggleProduct(product.id)}>Добавить в корзину</Link>
