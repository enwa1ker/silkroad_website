...
export default function Favorites({ product, total, money, basket, setBasket, value }) {
  ...
  return (
    <>
      ...
      <h6 className="mbbb-0">Избранные товары <IoIosHeart className='FavHeart'/></h6>
      <div className="FavİtemCount">
        <span> У вас {favoritesCount} избранных товаров</span>
              ...
              <div className="box-down">
                ...
                <Link className="cart" onClick={() => toggleProduct(product.id)}>
                  ...
                  <span className="add-to-cart">
                    <span className="txt" >
                      <Link to="/cart" className='GoToCartLink'>Перейти в корзину </Link>
