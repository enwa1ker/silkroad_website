  ...
  const renderMobileMenu = (
    ...
    >
      <MenuItem>
        ...
        <p className="MobilMenuİconLinks">Фильтр</p>
      </MenuItem>
      <MenuItem>
        <IconButton
          size="large"
        ...
        <Link to="/Favorites" className='MobilMenuİconLinks'>Избранные</Link>
      </MenuItem>
      <MenuItem onClick={handleProfileMenuOpen}>
        ...
        <Link to="/cart" className="MobilMenuİconLinks">Корзина</Link>
      </MenuItem>
    </Menu>
  );
  return (
